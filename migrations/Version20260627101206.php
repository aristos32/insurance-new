...
final class Version20260627101206 extends AbstractMigration
{
    ...
    {
        return 'Initial schema: single database with user, customer, and CRM tables';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (username VARCHAR(40) NOT NULL, password VARCHAR(60) NOT NULL, role VARCHAR(20) NOT NULL, status VARCHAR(20) NOT NULL, productType VARCHAR(20) DEFAULT NULL, subProductType VARCHAR(20) DEFAULT NULL, clientName VARCHAR(40) DEFAULT NULL, consecutiveFailLoginAttempts INT DEFAULT NULL, stateId VARCHAR(20) DEFAULT NULL, title VARCHAR(10) DEFAULT NULL, producer VARCHAR(20) DEFAULT NULL, gender VARCHAR(10) DEFAULT NULL, firstName VARCHAR(70) DEFAULT NULL, lastName VARCHAR(70) DEFAULT NULL, telephone VARCHAR(20) DEFAULT NULL, cellphone VARCHAR(20) DEFAULT NULL, profession VARCHAR(20) DEFAULT NULL, email VARCHAR(50) DEFAULT NULL, birthDate DATETIME DEFAULT NULL, licenseIssueDate DATETIME DEFAULT NULL, PRIMARY KEY (username)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE claims ADD CONSTRAINT FK_BEA313BEB5286BEF FOREIGN KEY (stateId) REFERENCES customer (stateId) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE drivingexperience ADD CONSTRAINT FK_60D5F817B5286BEF FOREIGN KEY (stateId) REFERENCES customer (stateId) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE license ADD CONSTRAINT FK_5768F419B5286BEF FOREIGN KEY (stateId) REFERENCES customer (stateId) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE customeraddress ADD CONSTRAINT FK_5187A45CB5286BEF FOREIGN KEY (stateId) REFERENCES customer (stateId) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE sale ADD CONSTRAINT FK_E54BC005B5286BEF FOREIGN KEY (stateId) REFERENCES customer (stateId) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customeraddress DROP FOREIGN KEY FK_5187A45CB5286BEF');
